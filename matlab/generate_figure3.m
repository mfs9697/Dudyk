...
fprintf(['Figure-3 one-degree-grid transition interpolation: ', ...
    'alpha1=%.4f deg, alpha2=%.4f deg. ', ...
    'Publication transition values are obtained from the continuous g2=0 solve.\n'], ...
    admissibility.alpha1_deg, admissibility.alpha2_deg);
...
fprintf(['Run run_figure3_tests to check the historical author T=40 ', ...
    'table by reverse mapping and verify convergence of the corrected ', ...
    'scientific sweep.\n']);
end
