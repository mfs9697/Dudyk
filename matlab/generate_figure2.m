...
fprintf(['Audit note: the consistent material-2 calculation at 10 degrees ', ...
    'does not reproduce both original deltaPrime and JPrime curves; see ', ...
...
for panel = 1:3
    ...
    for k = 1:numel(cases)
        handle = plot(ax, caseData{k}.sigma_prime, ...
            ...
            'Color', cases(k).color, 'LineWidth', 2.0, ...
...
legendHandle = legend(legendHandles, {cases.display_name}, ...
