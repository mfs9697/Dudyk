...
lambdaShear = nan(n, 1);
lambda1 = nan(n, 1);
lambda1Symmetry = nan(n, 1);
lambda2 = nan(n, 1);
lambda1D1Printed = nan(n, 1);
residual0 = nan(n, 1);
residualShear = nan(n, 1);
residual1 = nan(n, 1);
residual1Symmetry = nan(n, 1);
residual2 = nan(n, 1);
...
for k = 1:n
    ...
    lambda1Symmetry(k) = roots.lambda1_symmetry.selected;
    ...
    residual1Symmetry(k) = roots.lambda1_symmetry.residual;
    residual2(k) = roots.lambda2.residual;
end

lambda1SymmetryError = abs(lambda1 - lambda1Symmetry);
results = table(alphaDeg, lambda0, lambdaShear, lambda1, lambda2, ...
    lambda1Symmetry, lambda1SymmetryError, lambda1D1Printed, ...
    residual0, residualShear, residual1, residual2, residual1Symmetry, ...
    'VariableNames', {'alpha_deg', 'lambda0', 'lambda', 'lambda1', ...
    'lambda2', 'lambda1_symmetry', 'lambda1_symmetry_error', ...
    'lambda1_D1_printed', 'lambda0_residual', 'lambda_residual', ...
    'lambda1_residual', 'lambda2_residual', ...
    'lambda1_symmetry_residual'});
end
