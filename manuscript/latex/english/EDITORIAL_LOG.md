...
## Batch 5 — September 25, 2026

Scope: Abstract, keywords, Introduction, English metadata, and assembly of the
complete English manuscript. The translation is based on the final-swept
Ukrainian source carried by the Batch-4 branch. US spelling; no new literature,
equations, numerical results, or scientific claims were introduced.

### Abstract

- Preserved the prescribed stationary V-shaped interfacial shear crack and
  frictionless contact of its symmetric branches.
- Preserved the use of the corner singular field as the outer field for a
  small tensile process zone.
- Retained simultaneous compressive-contact/tensile-zone admissibility.
- Used "work done against separation resistance" and "zone-related energy
  parameter" consistently with Section 3.
- Kept the deformation and energy criteria equivalent only under consistent
  choice of their critical material parameters.
- Introduced no abbreviations or notation in the Abstract.

### Introduction

The source's eight-paragraph logic was preserved:

1. singular fields at angular/kinked bimaterial interfaces;
2. finite cohesive/process zones at initially undamaged corners;
3. existing interface cracks and kinking/deflection;
4. closely related analytical broken-interface/corner formulations;
5. the specific stationary V-shaped interfacial shear-crack field;
6. competition between the corner mechanism and outer-tip propagation;
7. the local process-zone variables and quantities to be determined;
8. the aim, methods, initiation criteria, and scope limitation.

The novelty statement was not strengthened beyond the Ukrainian source:
the unresolved point is the application of the existing local process-zone
framework to the specific field generated by the prescribed stationary
contacting V-shaped interfacial shear crack.

### Reading-order terminology and first use

- Mode II is introduced as in-plane shear at its first occurrence in the main
  text; Mode I is subsequently identified as opening mode in Section 2.
- Branch length `l` is defined before `d_i`; the total length of the two
  branches is stated as `2l`.
- The local quantities `d_i`, `delta_i`, `W_i`, and
  `J_i=dW_i/dd_i` are introduced before Section 2 begins their detailed
  derivation.
- "Zone-related energy parameter" is retained throughout; no global
  energy-release-rate interpretation is introduced for `J_i`.
- No SIF, PZ, CZM, or other shorthand was added.
- The terms "V-shaped interfacial shear crack," "process zone," "normal
  cohesive traction," "physical admissibility," "asymptotic matching," and
  "elastic contrast" are used consistently with Batches 1--4.

### Structural verification

- Abstract contains no display equations, labels, or citations, matching the
  source.
- Introduction label `sec:introduction` is preserved.
- Introduction citation uses: 23 Ukrainian / 23 English, exact key sequence.
- Complete manuscript citation uses: 37 Ukrainian / 37 English, exact key
  sequence.
- Complete structural labels: 34 Ukrainian / 34 English, exact set, no
  duplicates.
