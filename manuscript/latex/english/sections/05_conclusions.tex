...
matching, and the Wiener--Hopf method yield closed-form relations for the zone
...
considered here, on the physically admissible segments the cracked
configuration has the stronger stress singularity, whereas adding the process
zone partially shields it; specifically,
\begin{equation*}
