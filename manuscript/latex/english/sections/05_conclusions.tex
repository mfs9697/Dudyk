...
marginal and quantitative estimates should be treated with caution. The model addresses branching initiation only; the subsequent path and
stable propagation of the secondary crack lie outside the scope of the
present formulation.
