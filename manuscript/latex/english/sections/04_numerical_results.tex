...
Within each principal admissible interval, the angular dependence has a
pronounced maximum. Because $\delta_i'$ and $J_i'$ are proportional to
$d_i/l$ at fixed $\alpha$, the maxima of all three parameters are
coincident. Physically, the broken-interface geometry affects not the
material resistance threshold $J_{i\mathrm{c}}$ itself, but the value of
the zone-related energetic driving measure attained at a prescribed
external load. Hence, for a fixed $J_{i\mathrm{c}}$, angles near a
maximum correspond to less favorable geometrical configurations and a
lower critical applied load.
