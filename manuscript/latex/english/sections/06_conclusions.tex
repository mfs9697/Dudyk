...
\item
Formation of the process zone weakens the corner singularity but does not
eliminate it. On the physically admissible intervals for the baseline
...
the corner. No separate finite elastic additive term is consequently
required in the local energy criterion for branching initiation in this
corner problem.
...
when the independently specified material thresholds are calibrated
consistently,
