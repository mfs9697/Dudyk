...
singularity~\cite{NazarenkoKipnis2022Stress}. This field can support a process zone in one of the materials that can
...
zone~\cite{NazarenkoKipnis2022Stress}. In the inner problem, this matching condition takes the form
\begin{equation}
...
below. The functional problem is therefore formulated for the correction field,
with the known power-law term included in its prescribed part.
...
inside the zone, respectively. The boundary-value problem is
