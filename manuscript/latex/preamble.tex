...
% Working notes and resolved author queries are suppressed in the clean
% publication manuscript. Historical query dispositions are kept under docs/.
\newcommand{\worknote}[1]{}
\newif\ifshowauthorqueries
\showauthorqueriesfalse
...
% natbib styles emit DOI fields through \doi{...}; defining it here makes
% the DOI itself an external hyperlink and therefore uses urlcolor.
