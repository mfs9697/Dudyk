...
$\operatorname{Re}p<0$. Поблизу кутової точки градієнт переміщення
має порядок $r^{\lambda_i}$, тому $\Phi_i^-$ є аналітичною при
...
\begin{equation*}
  ...
  <\operatorname{Re}p<0.
\end{equation*}
Подальше розділення Вінера--Гопфа використовує аналітичне продовження
до межі $\operatorname{Re}p=0$: $\Phi_i^+$ продовжується зліва, а
$\Phi_i^-$ --- справа. Ядро рівняння має
вигляд
\begin{equation*}
