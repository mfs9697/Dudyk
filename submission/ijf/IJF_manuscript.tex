% International Journal of Fracture submission wrapper
% Springer Nature LaTeX layout: iicol; pdflatex; author-year references.
...
\abstract{\textbf{Purpose:} To develop an analytical model for branching initiation from
...
\citep{MohammedLiechti2000}, whereas Labossiere and Dunn examined fracture
initiation at three-dimensional bimaterial corners
\citep{LabossiereDunn2001}. Akisanya and Meng showed that the use of a
...
asymptotic field~\citep{AkisanyaMeng2003}. In modern cohesive formulations,
...
kinking from a corner point~\citep{DudykDikhtyarenko2012}, whereas Kaminsky,
Kipnis, and Polishchuk considered an initial fracture process zone arising
directly at the corner of a V-shaped interface
\citep{KaminskyKipnisPolishchuk2012}. For an interface crack with contacting
...
\citep{NazarenkoKipnis2022Equilibrium} determined the Mode~II stress
...
% Funding statement must be inserted after confirmation by all authors.
% Competing-interests statement must be inserted after confirmation by all authors.
% Author-contribution statement must be inserted after confirmation by all authors.

\paragraph{Data availability}
All data supporting the findings of this study are contained within the
article. The numerical curves and tabulated values are generated from the
analytical relations reported in the manuscript.
