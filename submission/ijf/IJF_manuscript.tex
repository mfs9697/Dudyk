...
% Keep DOI strings line-breakable but non-clickable in the two-column bibliography.
% This avoids pdfTeX link-nesting failures when a long DOI crosses a column/page boundary.
...
and the process zone. Section~3 uses the Mellin transform,
...
Section~3. Only combinations of material, angle, and
