...
modeling of crack nucleation for different bimaterial-joint angles, whereas \citet{LabossiereDunn2001} examined fracture
initiation at three-dimensional bimaterial corners. \citet{AkisanyaMeng2003} showed that the use of a
...
kinking from a corner point, whereas \citet{KaminskyKipnisPolishchuk2012} considered an initial fracture process zone arising
directly at the corner of a V-shaped interface. For an interface crack with contacting
...
For this configuration, \citet{NazarenkoKipnis2022Equilibrium} also determined the stress
...
The second mechanism is localized at the tips of the V-shaped crack branches. For those tips, \citet{NazarenkoKipnis2022Equilibrium} determined the Mode~II stress
