...
% Springer Nature sn-jnl, single-column, Math/Physical Sciences author-year style.
% Generated from the synchronized English scientific master.
\documentclass[pdflatex,onecolumn,sn-mathphys-ay]{sn-jnl}
...
% Local-compilation fallbacks. The GitHub Actions submission build provides
% flat Fig1--Fig4 files; a local checkout instead reuses the repository sources.
\IfFileExists{Fig2.pdf}
  {\def\FigTwoFile{Fig2.pdf}}
  {\IfFileExists{../../figures/figure2_recalculated.pdf}
    {\def\FigTwoFile{../../figures/figure2_recalculated.pdf}}
    {\def\FigTwoFile{figures/figure2_recalculated.pdf}}}
\IfFileExists{Fig3.pdf}
  {\def\FigThreeFile{Fig3.pdf}}
  {\IfFileExists{../../figures/figure3_recalculated.pdf}
    {\def\FigThreeFile{../../figures/figure3_recalculated.pdf}}
    {\def\FigThreeFile{figures/figure3_recalculated.pdf}}}
\IfFileExists{Fig4.pdf}
  {\def\FigFourFile{Fig4.pdf}}
  {\IfFileExists{../../figures/figure4_admissible_segments.pdf}
    {\def\FigFourFile{../../figures/figure4_admissible_segments.pdf}}
    {\def\FigFourFile{figures/figure4_admissible_segments.pdf}}}

\newcommand{\FigureOneGraphic}{%
  \IfFileExists{Fig1.pdf}
    {\includegraphics[width=\linewidth]{Fig1.pdf}}
    {\IfFileExists{../../manuscript/latex/figures/figure1_original_tikz.tex}
      {\resizebox{\linewidth}{!}{\input{../../manuscript/latex/figures/figure1_original_tikz.tex}}}
      {\resizebox{\linewidth}{!}{\input{manuscript/latex/figures/figure1_original_tikz.tex}}}}}

% Keep DOI strings line-breakable but non-clickable in the bibliography.
% This improves robustness for long DOI links in the review PDF.
...
\newcommand{\resultfigure}[4][\linewidth]{%
  \begin{figure}[htbp]
    \centering
...
\title[Branching from a V-shaped interfacial shear crack]{Analytical Model for Branching Initiation from the Corner of a V-Shaped Interfacial Shear Crack}

\author[1]{\fnm{Anatolii} \sur{Kaminsky}}
\author*[1]{\fnm{Mikhailo} \sur{Selivanov}}\email{mfs@ukr.net}
\author[1,2]{\fnm{Mykhailo} \sur{Dudyk}}
\author[2]{\fnm{Tetiana} \sur{Polishchuk}}
...
\abstract{\textbf{Purpose:} To develop an analytical model for branching initiation from the corner of a stationary V-shaped interfacial shear crack at a kinked bimaterial interface and to determine physically admissible process-zone states.

\textbf{Methods:} Under plane strain, the crack-corner singular field is used as the outer field for a small tensile process zone along a material-sector bisector. Mellin transformation, asymptotic matching, Wiener--Hopf factorization, and stress regularity at the zone tip are combined to obtain closed-form relations for the equilibrium process-zone characteristics.

\textbf{Results:} The analysis identifies the admissible material and loading branches and gives the equilibrium zone length, opening, work of separation, and zone-related energy parameter. The process zone weakens, but does not eliminate, the corner singularity. For fixed geometry, the deformation and energy characteristics are uniquely related. Corner branching and interfacial propagation from the crack-branch tips emerge as competing local mechanisms.

\textbf{Conclusion:} The formulation links the singular field of a stationary V-shaped interfacial shear crack to a closed analytical branching-initiation criterion and determines the critical applied load once the relevant material threshold is specified.}
...
\citeyearpar{MohammedLiechti2000}, whereas Labossiere and Dunn examined fracture
initiation at three-dimensional bimaterial corners
\citeyearpar{LabossiereDunn2001}. Akisanya and Meng showed that the use of a
...
asymptotic field~\citeyearpar{AkisanyaMeng2003}. In modern cohesive formulations,
...
kinking from a corner point~\citeyearpar{DudykDikhtyarenko2012}, whereas Kaminsky,
Kipnis, and Polishchuk considered an initial fracture process zone arising
directly at the corner of a V-shaped interface
\citeyearpar{KaminskyKipnisPolishchuk2012}. For an interface crack with contacting
...
\citep{NazarenkoKipnis2022Stress}. In the present work, the two symmetric
...
For this configuration, Nazarenko and Kipnis also determined the stress
intensity factor for in-plane shear (Mode~II) at the tips of the
V-shaped crack branches, formulated the limiting-equilibrium condition, and showed
that this equilibrium is unstable with respect to further interfacial
propagation~\citeyearpar{NazarenkoKipnis2022Equilibrium}. That mechanism is localized
...
\begin{aligned}
  ...
  &\hspace{37mm}
    ...
    \right]
  \Bigg\},\\[-1pt]
  &\hspace{8mm}\operatorname{Re}p<0,\\[3pt]
  \Phi_i^-(p)={}&
  K^-(p)G_i^-(p)
  \Bigg\{
  ...
  \Bigg\},\\[-1pt]
  &\hspace{8mm}\operatorname{Re}p>0.
\end{aligned}
\end{equation}
...
The second mechanism is localized at the tips of the V-shaped crack branches. For those tips, Nazarenko and Kipnis
\citeyearpar{NazarenkoKipnis2022Equilibrium} determined the Mode~II stress
...
used by Kaminsky and Dudyk~\citeyearpar{KaminskyDudyk2026Criteria}. For the
...
The numerical curves and tabulated values are generated from the analytical
relations reported in the manuscript.

% IMPORTANT: Springer/IJF requires a Competing Interests statement.
% Insert the author-approved statement before submission and also enter it
